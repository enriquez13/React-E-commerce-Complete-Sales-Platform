...
//}
  ...
  return (
    <>
    <div  className='ml-5 mt-3 text-2xl text-center pb-4'>Nuevo producto</div>
    ...
    <form  onSubmit={handleSubmit(onSubmit)} className='mx-7 text-black md:w-1/2'>
                ...
                <label htmlFor="func" className="form_label ">
                    Seleccionar Talla
                  <select name="seleccionar la talla " className='w-[3rem] ml-2'>
                    ...
                    <input  className='rounded-lg mt-5 bg-black text-white px-10 py-2 ' type="submit" value="Guardar producto" />
                    </div>
</form>
