  ...
  setTimeout( nextSlide , 2500) 
    ...
    return (
        <>
            ...
            {bartop===true ? <div  className='relative z-20 w-full bg-gray-700 top-0 text-center'>
                <div className="w-full h-[2rem] px-8  md:transform  md:hover:text-gray-700 
                flex items-center justify-center duration-1000 transition-all text-xs text-amber-200 tracking-[0.3rem] uppercase">
                ...
                <div className='flex relative items-center md:flex justify-center  py-4 md:px-10 px-7 bg-black bg-opacity-20'>
                    ...
                    <NavLink to='/cart'> <span className=' relative'><BsBag />
            {
              totalProducts() ? <span className="bg-blue-500 absolute bottom-[-10px] left-3 text-white text-base rounded-full px-2 ">
                {totalProducts()}
                    ...
                    md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0  transition-all duration-700 
