...
const Footer=()=>{
    ...
    return (
        <footer className="p-4 bg-black sm:p-6 pb-[3rem]">
            <div className="flex my-4 space-x-6 justify-center ">
                    ...
                    className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        <span fill="currentColor" aria-hidden="true" className="text-xl"><AiOutlineWhatsApp  /></span>
            ...
            <div className="md:flex md:justify-between">
                ...
                <div className="grid gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        <h2 className="mb-2 text-sm font-semibold text-gray-200 uppercase ">Información</h2>
                        <ul className="text-gray-400">
                            <li >
                                <a href="" className="hover:underline">Preguntas frecuentes</a>
                            </li>
                            <li>
                                <a href="" className="hover:underline">Direcciones</a>
                            </li>
                            <li>
